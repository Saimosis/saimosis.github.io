...
export const About = () => {
    ...
    return <section id="about" className="min-h-screen flex items-center justify-center py-20">
        ...
        <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-purple-600 to-purple-300 bg-clip-text text-transparent text-center"> About Me </h2>
                    ...
                    <div className="rounded-xl p-6 hover:-translate-y-1 transition all">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {frontendSkills.map((tech, key) => (
                                <span key={key} className="bg-purple-500/10 text-purple-500 py-1 px-3 rounded-full text-sm hover:bg-purple-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
                                    {tech}
                                </span>
                            ))}
                        </div>
